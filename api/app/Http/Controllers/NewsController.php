...
class NewsController extends Controller
{
     ...
     * Process French news
     */
    private function processFrenchNews(string $content, string $subject, string $messageId, ?string $imageUrl): bool
    {
        try {
     ...
     */
    private function processEnglishNews(string $content, string $subject, string $messageId, ?string $imageUrl): bool
    {
        try {
